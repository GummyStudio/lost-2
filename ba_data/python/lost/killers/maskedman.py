...
class MaskedManKiller(CharacterMoveset):
    ...
    description = (
        ...
        "Easter Bunny is quite a mixed killer, "
        "having a ranged ability, a movement ability, "
        "and a... combo M1???"
        "{'type': 'edit_text', 'color': (0.6, 0.6, 0.6)}"
        "...i doubt anyone gets the reference for this guy."
    )
    
    ability1_description = "Punches a survivor to deal damage to them. Also resets cooldown if it lands."
    ability2_description = "Charges up and shoot a fast projectile."
