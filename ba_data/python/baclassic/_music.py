...
ASSET_SOUNDTRACK_ENTRIES: dict[MusicType, AssetSoundtrackEntry] = {
    ...
    MusicType.LMS1: AssetSoundtrackEntry('lms1Music'),
    MusicType.LMS2: AssetSoundtrackEntry('lms2Music'),
    MusicType.LMS3: AssetSoundtrackEntry('lms3Music'),
    MusicType.LMS4: AssetSoundtrackEntry('lms4Music'),
    MusicType.LMS5: AssetSoundtrackEntry('lms5Music'),
    ...
    def _play_internal_music(self, musictype: MusicType | None) -> None:
        ...
        if musictype is not None:
            ...
            if entry is None:
                ...
                entry = ASSET_SOUNDTRACK_ENTRIES[MusicType.MENU]
